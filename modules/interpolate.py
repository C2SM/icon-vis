...
def create_remap_nl(gridtype, remap_namelist_path, data_file,
                                        file_out, 
                                        num_dates, out_regrid_options, 
                                        in_grid_file, out_grid_file=''):
...
def remap_ICON_to_regulargrid(data_file, in_grid_file, num_dates, region='Swizerland'):
    ...
    # Create namelist
    create_remap_nl('regular', remap_namelist_path, data_file,
                                        file_out, 
                                        num_dates,
                                        out_regrid_options,
                                        in_grid_file)
...
def remap_ICON_to_ICON(data_file, in_grid_file, out_grid_file, num_dates):
    ...
    # Create namelist
    create_remap_nl('icon', remap_namelist_path, data_file,
                                       file_out,
                                       num_dates, 
                                       out_regrid_options,
                                       in_grid_file, out_grid_file)
