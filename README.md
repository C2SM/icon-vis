...
[![Build Status](https://jenkins-mch.cscs.ch/job/pyvis_test_pipeline/badge/icon?config=build)](https://jenkins-mch.cscs.ch/job/pyvis_test_pipeline/badge/icon?config=build)
[![Build Status](https://jenkins-mch.cscs.ch/job/pyvis_test_pipeline/badge/icon?config=test)](https://jenkins-mch.cscs.ch/job/pyvis_test_pipeline/badge/icon?config=test)
